    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(choices=[('INT', 'Intern'), ('JUN', 'Junior'), ('MID', 'Middle'), ('SEN', 'Senior'), ('TCH', 'Tech Lead'), ('TML', 'Team Lead'), ('PM', 'Project Manager'), ('ARC', 'Architect'), ('DBA', 'Database Administrator'), ('QAE', 'Quality Assurance Engineer'), ('DEV', 'DevOps Engineer'), ('UI', 'UI/UX Designer'), ('CEO', 'Chief Executive Officer')], max_length=3, verbose_name='Position')),
